...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchStarCount = async () => {
      try {
        const response = await fetch('https://api.github.com/repos/0xmetaschool/HealthScribeGPT');
        ...
        <div className="flex justify-between items-center">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold mb-4 text-white">
              Build your own HealthScribe GPT
            </h3>
            <div className="flex items-center gap-4">
              <Link
                href="https://github.com/0xmetaschool/HealthScribeGPT/fork"
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <div className="flex items-center text-white/70">
              ...
              >
                ...
                <span className="text-white font-semibold">metaschool</span>
              </Link>
            </div>
            
            <div>
              <span className="text-white/70 mr-4">Follow us on</span>
